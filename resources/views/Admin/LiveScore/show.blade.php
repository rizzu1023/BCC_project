                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <form id="newBatsmanForm">
                                <div class="modal-body">
                                    ...
                                    <div class="col-md-6" id="where_batsman_runout" style="display:none;">
                                        <label for="wicket_primary" id="where_batsman_runout_label">Where got
                                            out?</label>
                                        <select class="form-control" id="wicket_primar"
                                ...
                                <div id="div_batsman_cross" class="custom-control custom-switch mt-2 mr-3"
                                     style="display: none">
                                    <input type="checkbox" class="custom-control-input" id="input_batsman_cross"
                                           name="isBatsmanCross">
                                    <label class="custom-control-label" for="input_batsman_cross"></label>did batsman
                                    crossed ?
                                </div>
                        ...
                        <div class="modal-footer">
                            <div id="all_out" class="custom-control custom-switch mt-2 mr-3" >
                                <input type="checkbox" class="custom-control-input" id="input_all_out"
                                       name="all_out" onchange="all_out_function(this)">
                                <label class="custom-control-label" for="input_all_out"></label>All Out ?
                            </div>
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-success ">Submit</button>
                        </div>
