                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Teams</span>
                                        <h4 class="mb-0 counter">{{$teams}}</h4><i class="icon-bg" data-feather="database"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-secondary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Players</span>
                                        <h4 class="mb-0 counter">{{$players}}</h4><i class="icon-bg" data-feather="shopping-bag"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-success b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Tournaments</span>
                                        <h4 class="mb-0 counter">{{$tournaments}}</h4><i class="icon-bg" data-feather="message-circle"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-info b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Matches</span>
                                        <h4 class="mb-0 counter">{{$matches}}</h4><i class="icon-bg" data-feather="user-plus"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
